...
CREATE TABLE IF NOT EXISTS `bos_fms` (
    ...
    PRIMARY KEY (`ID`)
)  ENGINE=MYISAM DEFAULT CHARSET=itf8mb4 COLLATE=utf8mb4_unicode_ci AUTO_INCREMENT=1;
...
CREATE TABLE IF NOT EXISTS `bos_signal` (
    ...
    `ric` VARCHAR(7) NOT NULL DEFAULT '0',
    PRIMARY KEY (`ID`)
)  ENGINE=MYISAM DEFAULT CHARSET=utf8mb4 COLLATE=utb8mb4_unicode_ci AUTO_INCREMENT=1;
