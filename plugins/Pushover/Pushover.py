...
def run(typ,freq,data):
	...
	try:
        ...
        if data["function"] == '1':
                priority = globals.config.get("Pushover", "priority1")
        elif data["function"] == '2':
                priority = globals.config.get("Pushover", "priority2")
        elif data["function"] == '3':
                priority = globals.config.get("Pushover", "priority3")
        elif data["function"] == '4':
                priority = globals.config.get("Pushover", "priority4")
        else:
                priority = 0
